	...
	<div class="container">
		<div class="row clearfix">
			<div class="col-lg-4 col-md-4 col-sm-4 t_xs_align_c">
				<p class="f_size_small">Welcome visitor!</p>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4 t_align_c t_xs_align_c">
				<p class="f_size_medium color_light">Promo message will be shown here!</p>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4 t_align_r t_xs_align_c">
				<p class="f_size_small">Call us toll free: <b class="color_light">(123) 456-7890</b></p>
			</div>
		</div>
	</div>
</section>
	...
	<div class="clearfix row">
		<div class="col-lg-4 col-md-5 col-sm-4 t_xs_align_c m_xs_bottom_15">
			...
			<ul class="d_inline_b horizontal_list clearfix f_size_small users_nav">
				<li><a href="#" class="default_t_color">Account</a></li>
				<li><a href="#" class="default_t_color">Custom Link</a></li>
				...
				<li><a href="#" class="default_t_color">Sign Up</a></li>
			</ul>
		</div>
		<div class="col-lg-8 col-md-7 col-sm-8 clearfix t_xs_align_c">
			<div class="relative f_left s_form_wrap_2">
				<a href="index.html" class="logo m_xs_bottom_10 d_inline_b">
	...
	<div class="container clearfix t_align_c">
		...
		<nav role="navigation" class="d_xs_none d_inline_b t_align_l">	
			<ul class="horizontal_list main_menu type_3 clearfix">
				<li class="relative f_xs_none m_xs_bottom_5 m_left_40 m_md_left_25 m_sm_left_10 m_xs_left_0"><a href="index.html" class="tr_delay_hover color_dark tt_uppercase r_corners"><b>Home</b></a>
					<!--sub menu-->
				...
				<li class="relative f_xs_none m_xs_bottom_5 m_left_40 m_sm_left_10 m_md_left_25 m_xs_left_0"><a href="index_layout_wide.html" class="tr_delay_hover color_dark tt_uppercase r_corners"><b>Sliders</b></a>
					<!--sub menu-->
					<div class="sub_menu_wrap top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners">
						<ul class="sub_menu">
				...
				<li class="relative f_xs_none m_xs_bottom_5 m_left_40 m_sm_left_10 m_md_left_25 m_xs_left_0"><a href="category_grid.html" class="tr_delay_hover color_dark tt_uppercase r_corners"><b>Shop</b></a>
					<!--sub menu-->
					<div class="sub_menu_wrap top_arrow d_xs_none tr_all_hover clearfix r_corners w_xs_auto">
						...
						<img src="images/woman_image_1.jpg" class="d_md_none f_right m_bottom_10" alt="">
					</div>
				</li>
				<li class="relative f_xs_none m_xs_bottom_5 m_left_40 m_sm_left_10 m_md_left_25 m_xs_left_0"><a href="category_grid.html" class="tr_delay_hover color_dark tt_uppercase r_corners"><b>Portfolio</b></a>
					<!--sub menu-->
					<div class="sub_menu_wrap top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners">
						<ul class="sub_menu">
				...
				<li class="relative f_xs_none m_xs_bottom_5 m_left_40 m_sm_left_10 m_md_left_25 m_xs_left_0"><a href="category_grid.html" class="tr_delay_hover color_dark tt_uppercase r_corners"><b>Pages</b></a>
					<!--sub menu-->
					<div class="sub_menu_wrap top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners">
						<ul class="sub_menu">
				...
				<li class="relative f_xs_none m_xs_bottom_5 m_left_40 m_sm_left_10 m_md_left_25 m_xs_left_0"><a href="blog.html" class="tr_delay_hover color_dark tt_uppercase r_corners"><b>Blog</b></a>
					<!--sub menu-->
					<div class="sub_menu_wrap top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners">
						<ul class="sub_menu">
				...
				<li class="relative f_xs_none m_xs_bottom_5 m_left_40 m_sm_left_10 m_md_left_25 m_xs_left_0"><a href="blog.html" class="tr_delay_hover color_dark tt_uppercase r_corners"><b>Features</b></a>
									<!--sub menu-->
									<div class="sub_menu_wrap top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners">
										<ul class="sub_menu">
				...
				<li class="relative f_xs_none m_xs_bottom_5 m_left_40 m_sm_left_10 m_md_left_25 m_xs_left_0"><a href="contact.html" class="tr_delay_hover color_dark tt_uppercase r_corners"><b>Contact</b></a></li>
			</ul>
		</nav>
	</div>
</section>
